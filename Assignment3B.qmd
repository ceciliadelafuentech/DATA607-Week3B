...
Solar Plot - create a subset of the dataframe to make the a plot with Solar data from 2020 to 2026
...
Wind Plot - create a subset of the dataframe to make the a plot with Wind data from 2020 to 2026
